#!/usr/bin/env sh
# Universal installer for stigsentry. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/stigsentry.git"
echo "Installing stigsentry ..."
