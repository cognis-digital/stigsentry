"""Native cognis-connect emit for stigsentry — forward findings to any platform.

Maps stigsentry's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    stigsentry ... --format json | stigsentry-emit --to stix
    stigsentry-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
